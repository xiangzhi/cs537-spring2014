/* CS 537 - Spring 2014
 * Modified by Xiang Zhi Tan
 * Created by their respective owners
 */
...
/* our getsyscallinfo excess here because we are registering the number of calls before starting */
int 
